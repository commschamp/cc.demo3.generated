...
struct SyncLayer
{
    ...
    {
        using Field = demo3::frame::FrameLayers<>::SyncMembers::Sync;
        return
...
struct SizeLayer
{
    ...
    {
        using Field = demo3::frame::FrameLayers<>::SizeMembers::Size;
        return
            cc::property::field::ForField<Field>()
                .name(Field::name())
                .displayOffset(2)
...
struct VersionLayer
{
    ...
    {
        using Field = demo3::frame::FrameLayers<>::VersionMembers::Version;
        return
            cc::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden()
...
struct ChecksumLayer
{
    ...
    {
        using Field = demo3::frame::FrameLayers<>::ChecksumMembers::Checksum;
        return
            cc::property::field::ForField<Field>()
                .name(Field::name())
                .asMap();
