...
#include "demo3/frame/FrameCommon.h"
...
struct FrameLayers
{
    ...
    struct VersionMembers
    {
        ...
        public:
            ...
            {
                return demo3::frame::FrameLayersCommon::VersionMembersCommon::VersionCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return demo3::frame::FrameLayersCommon::VersionMembersCommon::VersionCommon::name();
            }
        };
    };
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo3::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return demo3::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::name();
            }
        };
    };
    ...
    struct ChecksumMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo3::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return demo3::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::name();
            }
        };
    };
    ...
    struct SyncMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return demo3::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return demo3::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::name();
            }
