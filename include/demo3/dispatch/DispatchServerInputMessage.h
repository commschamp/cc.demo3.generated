...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo3::options::DefaultOptions.
/// @headerfile "demo3/dispatch/DispatchServerInputMessage.h"
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<demo3::options::DefaultOptions>;
