...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo3::options::DefaultOptions.
/// @headerfile "demo3/dispatch/DispatchMessage.h"
...
struct MsgDispatcher
{
    ...
    static auto dispatch(demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return demo3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<demo3::options::DefaultOptions>;
