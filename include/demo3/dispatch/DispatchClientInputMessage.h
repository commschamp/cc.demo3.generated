...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo3::options::DefaultOptions.
/// @headerfile "demo3/dispatch/DispatchClientInputMessage.h"
...
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref demo3::options::DefaultOptions as template parameter.
/// @note Defined in "demo3/dispatch/DispatchClientInputMessage.h"
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<demo3::options::DefaultOptions>;
