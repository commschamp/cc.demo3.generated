...
#include "cc_demo3/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile cc_demo3/message/Msg1.h
...
struct Msg1Fields
{
    ...
    public:
        ...
        {
            return cc_demo3::message::Msg1FieldsCommon::F1Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_demo3::message::Msg1FieldsCommon::F1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_demo3::message::Msg1FieldsCommon::F2Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_demo3::message::Msg1FieldsCommon::F2Common::name();
        }
    };
    ...
    struct F2 : public
        comms::field::Optional<
            ...
            comms::option::def::ExistsUntilVersion<1>,
            comms::option::def::HasName    >
    {
        /// @brief Name of the field.
        static const char* name()
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_demo3::message::Msg1FieldsCommon::F3Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_demo3::message::Msg1FieldsCommon::F3Common::name();
        }
    };
    ...
    struct F3 : public
        comms::field::Optional<
            F3Field,
            comms::option::def::ExistsByDefault,
            comms::option::def::ExistsSinceVersion<3>,
            comms::option::def::HasName    >
    {
        /// @brief Name of the field.
        static const char* name()
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_demo3::message::Msg1FieldsCommon::F4Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_demo3::message::Msg1FieldsCommon::F4Common::name();
        }
    };
    ...
    struct F4 : public
        comms::field::Optional<
            F4Field,
            comms::option::def::ExistsByDefault,
            comms::option::def::ExistsBetweenVersions<3, 4>,
            comms::option::def::HasName    >
    {
        /// @brief Name of the field.
        static const char* name()
...
public:
    ...
    {
        return cc_demo3::message::Msg1Common::name();
    }
};
