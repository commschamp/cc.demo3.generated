...
/// @note Defined in cc_demo3/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_demo3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_demo3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_demo3::options::DefaultOptions.
/// @headerfile cc_demo3/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(cc_demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_demo3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return cc_demo3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
