...
///     like @ref cc_demo3::options::DefaultOptions.
...
///     @code
///     using MyInterface = cc_demo3::Message<...>;
///     using MyConnect = cc_demo3::message::Connect<MyInterface, cc_demo3::options::DefaultOptions>;
///     using MyMsg1 = cc_demo3::message::Msg1<MyInterface, cc_demo3::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in cc_demo3/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case cc_demo3::MsgId_Connect:
    {
        using MsgType = cc_demo3::message::Connect<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case cc_demo3::MsgId_Msg1:
    {
        using MsgType = cc_demo3::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     cc_demo3::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_demo3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_demo3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_demo3::options::DefaultOptions.
/// @headerfile cc_demo3/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = cc_demo3::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(cc_demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(cc_demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_demo3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref cc_demo3::options::DefaultOptions as template parameter.
/// @note Defined in cc_demo3/dispatch/DispatchServerInputMessage.h
