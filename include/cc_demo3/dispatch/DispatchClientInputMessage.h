...
///     using MySomeMessage = SomeMessage<MyInterface, cc_demo3::options::DefaultOptions>;
///     using MySomeOtherMessage = SomeOtherMessage<MyInterface, cc_demo3::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in cc_demo3/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<cc_demo3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<cc_demo3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_demo3::options::DefaultOptions.
/// @headerfile cc_demo3/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(cc_demo3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_demo3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_demo3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
