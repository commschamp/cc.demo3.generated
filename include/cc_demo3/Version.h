...
#define CC_DEMO3_SPEC_VERSION (5)

/// @brief Major version of the protocol library.
#define CC_DEMO3_MAJOR_VERSION (3)

/// @brief Minor version of the protocol library.
#define CC_DEMO3_MINOR_VERSION (0)

/// @brief Patch version of the protocol library.
#define CC_DEMO3_PATCH_VERSION (5)

/// @brief Full version of the protocol library as single number.
#define CC_DEMO3_VERSION (COMMS_MAKE_VERSION(CC_DEMO3_MAJOR_VERSION, CC_DEMO3_MINOR_VERSION, CC_DEMO3_PATCH_VERSION))
