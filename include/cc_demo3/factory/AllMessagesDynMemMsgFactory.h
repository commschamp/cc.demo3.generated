...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case cc_demo3::MsgId_Connect: return MsgPtr(new cc_demo3::message::Connect<TInterface, TProtOptions>);
            case cc_demo3::MsgId_Msg1: return MsgPtr(new cc_demo3::message::Msg1<TInterface, TProtOptions>);
            default: break;
        }
