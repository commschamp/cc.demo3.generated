...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 1 /* 0x1 */: return MsgPtr(new cc_demo3::message::Connect<TInterface, TProtOptions>);
            case 2 /* 0x2 */: return MsgPtr(new cc_demo3::message::Msg1<TInterface, TProtOptions>);
            default: break;
        }
