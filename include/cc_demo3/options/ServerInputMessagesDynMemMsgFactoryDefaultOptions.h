...
#include "cc_demo3/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo3::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo3::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
