...
#include "cc_demo3/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo3::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo3::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
