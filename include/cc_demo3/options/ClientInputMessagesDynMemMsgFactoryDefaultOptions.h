...
#include "cc_demo3/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo3::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo3::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
